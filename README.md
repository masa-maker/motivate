...
|性別と年齢層                                             |
|-------------------------------------------------------|
|鍛えた体を共有するアプリを考えている「性別は男性」に設定しました。|
|日常的に体を鍛えている20代をターゲットとしました。             |
...
| フッター          | アプリ内全画面に共通して無断コピーなどの防止の為、「コピーライト」の表示をします。 | アプリ内全画面に共通して「コピーらいと」の表示をします。                |
...
![good](https://user-images.githubusercontent.com/76035698/106377865-6d745a80-63e3-11eb-8a84-c1884b8095a7.gif)
